  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use Product.tags.update() instead.
        "prototype$__update__tags": {
          url: urlBase + "/products/:id/tags",
          method: "PUT"
        },

        // INTERNAL. Use Product.tags.destroy() instead.
    ...
    */
     ...
     */
        ...
        /**
         * @ngdoc method
         * @name lbServices.Product.tags#destroy
         * @methodOf lbServices.Product.tags
         *
         * @description
         *
        ...
        R.tags.destroy = function() {
          var TargetResource = $injector.get("Tag");
          var action = TargetResource["::destroy::product::tags"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Product.tags#update
         * @methodOf lbServices.Product.tags
         *
         * @description
         *
        ...
        R.tags.update = function() {
          var TargetResource = $injector.get("Tag");
          var action = TargetResource["::update::product::tags"];
          return action.apply(R, arguments);
        };
